...
## Result
    ...
    ruby Support/test/suite.rb    # 107 tests, 576 assertions, 100%
...
- The `Test/project` fixture README documents the build-test projects; `settings.rb` grew no new coverage.
